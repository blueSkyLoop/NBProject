//
//  NBLoDownLoadController.m
//  NBProject
//
//  Created by Lucas on 2018/8/23.
//  Copyright © 2018年 com.cn. All rights reserved.
//

#import "NBLoDownLoadController.h"
#import "ZYLDownloader.h"
@interface NBLoDownLoadController ()<ZYLDownloaderDelegate>
...
@implementation NBLoDownLoadController
...
- (IBAction)getAll:(UIButton *)sender {
    NSLog(@"读取所有数据：%@", [self.dowl getAllDownloadersInfo]);
}
...
- (void)downloaderRate:(float)rate withDownloaderUrl:(NSString *)downloaderUrl {
    float newRate =  [[NSString stringWithFormat:@"%.2lf",rate] floatValue];
    NSInteger intagerValue = newRate * 100;
    NSString *value = [NSString stringWithFormat:@"%ld%%",intagerValue];
    ...
    switch (index) {
        ...
        case 2:
            ...
            break;
        case 3:
            self.four.text = value;
            break;
        case 4:
            self.five.text = value;
            break;
        default:
