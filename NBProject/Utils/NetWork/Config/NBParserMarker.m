...
#import "NBParserMarker.h"
#import "YYModel.h"

@interface NBParserMarker()
...
- (ParserKeyBlock)parserKey{
    return ^NBParserMarker *(NSString *aparserKey) {
        if(aparserKey){
...
- (ParserKeyBlock)keyClassName{
    return ^NBParserMarker *(NSString *akeyClassName) {
...
- (ParserKeyBlock)className{
    return ^NBParserMarker *(NSString *aclassName) {
