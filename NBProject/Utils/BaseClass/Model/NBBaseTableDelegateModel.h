...
@interface NBBaseTableDelegateModel : NSObject<UITableViewDelegate,UITableViewDataSource>
...
@property (nonatomic,copy)void(^mh_tableViewRowCellBlock)(NSIndexPath *indexPath,UITableViewCell<NBCellConfigDelegate> *acell);
