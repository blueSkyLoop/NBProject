...
@interface NBBaseCollectionDelegateModel : NSObject<UICollectionViewDelegate,UICollectionViewDataSource>
...
@property (nonatomic,copy)void(^mh_collectionViewRowCellBlock)(NSIndexPath *indexPath,UICollectionViewCell<NBCellConfigDelegate> *acell);
