...
#import "NBBaseCollectionDelegateModel.h"

@interface NBBaseCollectionDelegateModel()
...
@implementation NBBaseCollectionDelegateModel
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UICollectionViewCell<NBCellConfigDelegate> *cell = [collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass(aclass) forIndexPath:indexPath];
