...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return [tableView fd_heightForCellWithIdentifier:NSStringFromClass(aclass) cacheByIndexPath:indexPath configuration:^(UITableViewCell<NBCellConfigDelegate> *cell) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    Class aclass = [self cellClassWithIndexPath:indexPath];
    UITableViewCell<NBCellConfigDelegate> *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass(aclass)];
